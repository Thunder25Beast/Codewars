    ...
    ((up == "island1" and s[0] == "myCaptured") +
     ...
     (right == "island3" and s[2] == "myCaptured")==1
        ...
        if pirate.getTeamSignal() != "":
            ...
            x = int(l[0][1:])
            y = int(l[1])
            x1= int(pirate.GetDimensionX())/2
            r=math.sqrt( (x-x1)**2+(y-x1)**2 ) 
            (x3, y3) = (-0.5) + (x - x1) * (-0.5) - (y - x1) * 0.866, x1 + r * 0.866 + (x - x1) * 0.866 + (y - x1) * (-0.5)
            (x2, y2) = x1 + r * (-0.5) + (x - x1) * (-0.5) - (y - x1) * (-0.866), x1 + r * (-0.866) + (x - x1) * (-0.866) + (y - x1) * (-0.5)
